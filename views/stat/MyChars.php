...
$data = UsersCharacters::find()->select(['name', 'account', 'last_login'])->from('users_characters')
    ->Where(['not', ['last_login' => null]])->Where(['account' => Yii::$app->user->identity->username])
    ->limit(5)->orderBy('last_login DESC')->asArray()->all();
$count = 1;
?>
